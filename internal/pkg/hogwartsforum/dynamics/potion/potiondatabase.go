...
var PotionScores = map[string]int{
	AgudizadoraDeIngenio:            20,
	AlientoDeFuego:                  22,
	Amortentia:                      26,
	AntidotoParaVenenosComunes:      20,
	AntidotoDeGlumbumble:            20,
	AntidotoParaVenenosToxicos:      26,
	BrebajeParlanchin:               24,
	Doxycida:                        20,
	ElixirParaInducirEuforia:        24,
	Embellecedora:                   24,
	EsenciaDeDictamo:                20,
	EsenciaDeMurtlap:                24,
	FelixFelicis:                    26,
	FertilizanteDeEstiercolDeDragon: 26,
	FiltroDeMuertosEnVida:           27,
	FiltroDePaz:                     20,
	GraspOfDeath:                    27,
	Multijugos:                      25,
	PocionCalmante:                  24,
	PocionCrecepelo:                 24,
	PocionCuradoraDeFurunculos:      24,
	PocionDeDespertares:             24,
	PocionDeErumpent:                26,
	PocionDeLaMemoria:               27,
	PocionDeLaRisa:                  22,
	PocionDelOlvido:                 27,
	PocionHerbicida:                 22,
	PocionHerbovitalizante:          22,
	PocionOculus:                    24,
	PocionParaElDolorDeEstomago:     24,
	PocionPimentonica:               25,
	PocionProtectoraContraLasLlamas: 26,
	PocionVigorizante:               27,
	PocionVolubilis:                 25,
	PocimaParaDormir:                24,
	SolucionAgrandadora:             20,
	SolucionEncogedora:              20,
	Veritaserum:                     26,
	ZumoDeMandragora:                27,
}
